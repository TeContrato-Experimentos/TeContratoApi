...
namespace TeContrato.API.Controllers
{
    ...
    public class ProjectController : ControllerBase
    {
        ...
        [ProducesResponseType(typeof(BadRequestResult), 404)]
        public async Task<IActionResult> PostAsync(int clientId, int TechnicianId, int budgetId, [FromBody] SaveProjectResource resource)
        {
            ...
            var result = await _projectService.SaveAsync(clientId, TechnicianId, budgetId, project);
