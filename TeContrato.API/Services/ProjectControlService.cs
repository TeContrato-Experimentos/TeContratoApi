...
namespace TeContrato.API.Services
{
    public class ProjectControlService : IProjectControlService
    {
        ...
        public ProjectControlService(IProjectControlRepository TechnicianRepository, IStatusRepository statusRepository, IProjectRepository projectRepository, IUnitOfWork unitOfWork)
        {
            _cityRepository = TechnicianRepository;
